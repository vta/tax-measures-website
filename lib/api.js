...
export async function fetchAwards() {
  const response = await fetch(`${process.env.HOST}/api/awards`)
...
export async function fetchDocuments() {
  const response = await fetch(`${process.env.HOST}/api/documents`)
...
export async function fetchRevenue() {
  const response = await fetch(`${process.env.HOST}/api/revenue`)
