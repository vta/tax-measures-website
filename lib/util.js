...
export async function preprocessData(data) {
  ...
  for (const award of data.awards) {
    ...
    if (!project) {
      award.fields.category = 'Uncategorized';
      award.fields['Parent Category'] = 'Uncategorized';
    } else {
  ...
  for (const payment of data.payments) {
    ...
    if (!project) {
      payment.fields.category = 'Uncategorized';
      payment.fields['Parent Category'] = 'Uncategorized';
    } else {
