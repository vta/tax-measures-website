...
const BarChart = ({ results }) => {
  ...
  const formatChartData = () => {
    const categoryGroups = results.filters.category ? groupBy(results.items, item => item.fields.Category.fields.Name) : groupBy(results.items, item => item.fields['Parent Category'].fields.Name)
